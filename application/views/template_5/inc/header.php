    ...
    <div class="container">  
        ...
        <nav class="navbar navbar-default navbar-static-top tm_navbar clearfix" role="navigation">
            ...
            <ul class="nav sf-menu clearfix">
              ...
              <li class='<?php echo $menu == 'Home' ? 'active' : '' ?>'><a href='<?php echo base_url() . 'web/index' ?>'><span>Home</span></a></li>
               <li class='<?php echo $menu == 'home' ? 'active' : '' ?>'><a href='<?php echo base_url() . 'web/about' ?>'><span>About</span></a></li>

                <li><a href="index-2.html">Gallery</a></li>

                <li><a href="index-3.html">Product</a></li>
