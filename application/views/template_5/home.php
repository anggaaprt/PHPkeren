...
<div class="thumb-box7">
    <div class="container">
        ...
        <ul class="list2">
        <?php foreach ($sql_menu1_segment9 as $row_segment) { ?>

            <li class="wow fadeInUp"><a href="#"><img src="img/page1_logo1.png" alt=""></a></li>

            <li class="wow fadeInUp" data-wow-delay="0.1s"><a href="#"><img src="<?php echo base_url().'upload/'.$row_segment->images;?>" alt=""></a></li>
